...
The registry of every system your AIOS can reach. This is the Reach layer made visible. Each row is one of the seven domains every business runs on. `/onboard` fills the tool names from your intake. You wire the mechanism over time, one tool at a time.

| # | Domain | Engine | Tool | Mechanism | Auth | Last checked |
|---|---|---|---|---|---|---|
| 1 | Revenue and financials | Growth | _filled by /onboard_ | not yet connected | | |
| 2 | Customer interactions | Growth | _filled by /onboard_ | not yet connected | | |
| 3 | Calendar | Both | _filled by /onboard_ | not yet connected | | |
| 4 | Communication | Both | _filled by /onboard_ | not yet connected | | |
| 5 | Project and task tracking | Fulfillment | _filled by /onboard_ | not yet connected | | |
| 6 | Meeting intelligence | Fulfillment | _filled by /onboard_ | not yet connected | | |
| 7 | Knowledge and files | Both | _filled by /onboard_ | not yet connected | | |
